...
const Slider_Banner_App = ({ app, isActive }) => {
          ...
          <div className="flex justify-between items-center mt-2">
            <div className="flex gap-2 sm:gap-3 items-center">
              <img
                ...
                alt="App Thumbnail"
              />
              <p className="text-xs sm:text-sm md:text-base text-amber-50 font-medium truncate max-w-[140px] sm:max-w-[200px]">
                {app.subtitle}
              </p>
            </div>
            <button className="btn btn-success text-xs sm:text-sm md:text-base px-3 sm:px-4 py-1 sm:py-2">
              Install
            </button>
          </div>
        </div>
...
export default Slider_Banner_App;
