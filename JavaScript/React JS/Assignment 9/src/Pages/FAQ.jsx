...
const FAQ = () => {
  ...
  return (
    <section className="w-full px-4 sm:px-6 md:px-8 lg:px-12 py-10 bg-white dark:bg-base-100">
      <h2 className="text-2xl text-base-content sm:text-3xl md:text-4xl font-bold text-center text-neutral mb-10">
      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-4">
        {faqs.map((faq, idx) => (
          ...
          >
            ...
            <div className="collapse-title text-base sm:text-lg md:text-xl font-medium peer-checked:text-primary">
              {faq.question}
            </div>
